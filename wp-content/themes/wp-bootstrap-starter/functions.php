...
function wp_bootstrap_starter_scripts() {
	...
	wp_enqueue_style( 'solarized-dark', get_template_directory_uri() . '/inc/highlight/styles/solarized-dark.css' );
    // fontawesome cdn
    ...
    wp_enqueue_script('highlight-pack-js', get_template_directory_uri() . '/inc/highlight/highlight.pack.js', array(), '', true );
