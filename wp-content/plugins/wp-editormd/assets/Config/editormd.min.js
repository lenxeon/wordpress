(function ($, doc, win, editor) {
        ...
        try {
            if (doc.getElementById("wp-content-editor-container") !== undefined) {
                var wpEditormd = editormd({
                    ...
                    width: "100%",
                    height: 640,
                    syncScrolling: editor.syncScrolling !== "off",
                    watch: editor.watch !== "off",
                    htmlDecode: editor.htmlDecode !== "off",
                    toolbarAutoFixed: true,
                    tocm: false,
                    tocContainer: editor.toc === "off" ? false : "",
                    tocDropdown: false,
                    theme: editor.theme,
                    previewTheme: editor.previewTheme,
                    editorTheme: editor.editorTheme,
                    emoji: editor.emoji !== "off",
                    tex: editor.tex !== "off",
                    mind: editor.mindMap !== "off",
                    mermaid: editor.mermaid !== "off",
                    atLink: false,
                    taskList: editor.taskList !== "off",
                    placeholder: editor.placeholderEditor,
                    prismTheme: editor.prismTheme,
                    prismLineNumbers: editor.prismLineNumbers !== "off",
                    toolbarIcons: function () {
                        return ["undo", "redo", "|", "bold", "del", "italic", "quote", "ucwords", "uppercase", "lowercase", "|", "h1", "h2", "h3", "h4", "h5", "h6", "|", "list-ul", "list-ol", "hr", "|", "link", "reference-link", "image", "code", "preformatted-text", "code-block", "table", "datetime", "html-entities", "more", "pagebreak", editor.emoji !== "off" ? "emoji" : "toc", "|", "goto-line", "watch", "preview", "fullscreen", "clear", "search", "|", "help", "info"]
                    },
                    onfullscreen: function () {
                        $("#wp-content-editor-container").css({position: "fixed", "z-index": "99999"})
                    },
                    onfullscreenExit: function () {
                        $("#wp-content-editor-container").css({position: "relative", "z-index": "auto"})
                    },
                    toolbarIconsClass: {toc: "fa-list-alt", more: "fa-ellipsis-h"},
                    toolbarHandlers: {
                    ...
                    lang: {toolbar: {toc: "The Table Of Contents", more: "More"}}
                });
                    ...
                    $("#wp-content-editor-container").on("paste", function (event) {
                        ...
                        if ((itemLength === 1 && cbd.items[0].kind === "file")) {
                            ...
                            readBlobAsDataURL(blob, function (dataurl) {
                                ...
                                var data = {action: "imagepaste_action", dataurl: dataurl};
                                wpEditormd.insertValue(uploadingText);
                                $.ajax({
                                    url: ajaxurl, type: "post", data: data, success: function (request) {
            ...
            console.log("wpEditormd", wpEditormd);
            window.wpEditormd = wpEditormd;
        } catch (e) {
            console.error(e)
        }
    });
    editormd.prismURL = {url: cdn_url(editor.staticFileCDN, "prism_config")};
    if (editor.tex === "on") {
        editormd.katexURL = {
    ...
    if (editor.mermaid === "on") {
        editormd.mermaidURL = {js: cdn_url(editor.staticFileCDN, "mermaid_config") + "/mermaid.min"}
    }
    if (editor.emoji === "on") {
        editormd.emoji = {path: cdn_url(editor.staticFileCDN, "emojify") + "/", ext: ".png"}
    }
